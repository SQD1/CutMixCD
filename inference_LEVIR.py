...
def get_arguments():
    ...
    parser.add_argument("--weight_path", type=str, default='../semi_checkpoints/LEVIR/CutMixCD/cutmix_0.1/best.pth')
    parser.add_argument("--data_root", type=str, default='/data0/qidi/LEVIR-CD256')
